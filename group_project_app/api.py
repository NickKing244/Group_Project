...
GOOGLE_API_KEY = "AIzaSyDQT3KX-oKZoCaHemw_vaG_KG0v2Rivx20"
class GoogleMapsClient(object):
    ...
    def __init__(self, api_key="AIzaSyDQT3KX-oKZoCaHemw_vaG_KG0v2Rivx20", address_or_postal_code= None, *args, **kwargs):
